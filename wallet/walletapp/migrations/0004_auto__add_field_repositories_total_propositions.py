...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repositories.total_propositions'
        db.add_column(u'walletapp_repositories', 'total_propositions',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repositories.total_propositions'
        db.delete_column(u'walletapp_repositories', 'total_propositions')
