...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Favourites.repository'
        db.add_column(u'walletapp_favourites', 'repository',
        ...
        # Adding field 'Proposition.repository'
        db.add_column(u'walletapp_proposition', 'repository',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['walletapp.Repositories']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Favourites.repository'
        db.delete_column(u'walletapp_favourites', 'repository_id')
        ...
        # Deleting field 'Proposition.repository'
        db.delete_column(u'walletapp_proposition', 'repository_id')
